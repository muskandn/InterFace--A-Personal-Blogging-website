...
const homeStartingContent = "Whether sharing your expertise, breaking news, or whatever’s on your mind, you’re in good company on Blogger. Sign up to discover why millions of people have published their passions here.";
...
app.post("/compose", function(req, res){
  ...
  const post = new Post({title,content,name});
